...
<nav class="teal lighten-2">
  ...
  <li><a href="user/user_home.php" class="white-text"><i class="mdi-navigation-menu"></i>  </a></li>
  <li><a class="white-text" href="#!"><i class="small mdi-content-report"></i>  Warnings</a></li>
  <li><a class="white-text" href="../weather_user.php"><i class="small mdi-content-sort"></i>  News</a></li>
  ...
  <li><a class="white-text" href="#!"><i class="small mdi-action-accessibility"></i>  HelpLine</a></li>
  </ul>
<ul class="right">
